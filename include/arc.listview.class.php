...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
		...
		$mokedir = $this->Fields['typedir'];

        //获得上一页和主页的链接
        if($this->PageNo != 1)
        {
            $prepage.="<li><a href='/#!$mokedir/".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></li>\r\n";
            $indexpage="<li><a href='/#!$mokedir/".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li>首页</li>\r\n";
        ...
        {
            $nextpage.="<li><a href='/#!$mokedir/".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></li>\r\n";
            $endpage="<li><a href='/#!$mokedir/".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
            $endpage="<li>末页</li>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<li><a href='/#!$mokedir/".str_replace("{page}",$j,$tnamerule)."'>".$j."</a></li>\r\n";
            }
        }
        $plist = '';
